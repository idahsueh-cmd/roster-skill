...
- PRs that touch shared files (marked `ALL` in ROSTER.md) should merge last.
...
3. Are there any unresolved conflicts in `ROSTER.md`?
...
- Rename `ROSTER.md` → `ROSTER-<today's date>.md`
- If `ROSTER-detail.md` exists, rename it → `ROSTER-detail-<today's date>.md`
